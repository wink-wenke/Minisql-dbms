...
public class SemanticAnalyzerTest {
    ...
    public static void main(String[] args) {
      ...
      SimpleDB.DB_BASE_DIR = "tmp";
        ...
        tx.commit();
        System.out.println("  Catalog: CREATE TABLE student(id INT, name VARCHAR(20), age INT)");
        System.out.println("  Catalog: CREATE TABLE course(cid INT, title VARCHAR(30))\n");
        ...
        System.out.println("\n├─ 语义分析结果: 通过 " + passed + " / 失败 " + failed + " / 总计 " + (passed + failed) + " ─┤");
